...
namespace Confuser.Optimizations.CompileRegex.Compiler {
	internal struct RegexCode {
		...
		private static readonly FieldInfo _trackcountField =
			RU.GetField(_realRegexCodeType, "_trackcount", "TrackCount");
		...
		private static readonly FieldInfo _rightToLeftField =
			RU.GetField(_realRegexCodeType, "_rightToLeft", "RightToLeft");
