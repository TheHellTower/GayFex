...
namespace Confuser.Optimizations.TailCall {
	...
	internal static class LoggerExtensions {
		private static readonly Action<ILogger, MethodDef, Exception> _scanningMethodForTailCall =
		...
		private static readonly Action<ILogger, MethodDef, uint, Exception> _foundTailCallInMethod =
			LoggerMessage.Define<MethodDef, uint>(
				LogLevel.Debug, new EventId(20102, "opti-102"),
				"Found tail call in {Method} at instruction IL_{Offset:X4}");

		internal static void
			LogMsgFoundTailCallInMethod(this ILogger logger, MethodDef method, Instruction instruction) =>
		...
		private static readonly Action<ILogger, MethodDef, Exception> _scanningMethodForTailRecursion =
			LoggerMessage.Define<MethodDef>(
		...
		private static readonly Action<ILogger, MethodDef, uint, Exception> _foundTailRecursionInMethod =
			LoggerMessage.Define<MethodDef, uint>(
				LogLevel.Debug, new EventId(20112, "opti-112"),
				"Found tail recursion in {Method} at instruction IL_{Offset:X4}");

		internal static void LogMsgFoundTailRecursionInMethod(this ILogger logger, MethodDef method,
			Instruction instruction) =>
			_foundTailRecursionInMethod(logger, method, instruction.GetOffset(), null);

		private static readonly Action<ILogger, int, Exception> _totalInjectedTailRecursions =
		...
		private static readonly Func<ILogger, MethodDef, IDisposable> _addTailCallScope =
			LoggerMessage.DefineScope<MethodDef>(
		...
		private static readonly Func<ILogger, MethodDef, IDisposable> _optimizeRecursionScope =
			LoggerMessage.DefineScope<MethodDef>(
