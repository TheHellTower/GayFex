...
namespace Confuser.Protections.ControlFlow {
	internal sealed class ControlFlowProtectionParameters : ProtectionParametersBase {
		internal IProtectionParameter<CFType> ControlFlowType { get; } =
			ProtectionParameter.Enum("type", CFType.Switch);

		internal IProtectionParameter<PredicateType> PredicateType { get; } =
			ProtectionParameter.Enum("predicate", ControlFlow.PredicateType.Normal);
