...
namespace Confuser.Protections.ReferenceProxy {
	internal sealed class ReferenceProxyProtectionParameters {
		internal IProtectionParameter<Mode> Mode { get; } = ProtectionParameter.Enum("mode", ReferenceProxy.Mode.Mild);
		internal IProtectionParameter<EncodingType> Encoding { get; } = ProtectionParameter.Enum("encoding", EncodingType.Normal);
