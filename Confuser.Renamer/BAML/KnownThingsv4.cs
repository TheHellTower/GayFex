	...
	internal class KnownThingsv4 : IKnownThings {
		...
		void InitAssemblies(ModuleDefMD initMod) {
			...
			assemblies[2] =
				context.Resolver.ResolveThrow(
					"System.Xaml, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", initMod);
			assemblies[3] =
				context.Resolver.ResolveThrow(
					"mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", initMod);
			assemblies[4] =
				context.Resolver.ResolveThrow(
					"System, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", initMod);
			assemblies[5] =
				context.Resolver.ResolveThrow(
					"WindowsBase, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35", initMod);
			assemblies[6] =
				context.Resolver.ResolveThrow(
					"System.Xml, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", initMod);
		}
		...
		void InitTypes() {
			...
			types[KnownTypes.ContentPropertyAttribute] =
				assemblies[2].Find("System.Windows.Markup.ContentPropertyAttribute", true);
			types[KnownTypes.ContentWrapperAttribute] =
				assemblies[2].Find("System.Windows.Markup.ContentWrapperAttribute", true);
			...
			types[KnownTypes.CultureInfoConverter] =
				assemblies[4].Find("System.ComponentModel.CultureInfoConverter", true);
			...
			types[KnownTypes.IComponentConnector] =
				assemblies[2].Find("System.Windows.Markup.IComponentConnector", true);
			...
			types[KnownTypes.ModifierKeysConverter] =
				assemblies[5].Find("System.Windows.Input.ModifierKeysConverter", true);
			...
			types[KnownTypes.WhitespaceSignificantCollectionAttribute] = assemblies[2]
			...
			types[KnownTypes.XmlLangPropertyAttribute] =
				assemblies[2].Find("System.Windows.Markup.XmlLangPropertyAttribute", true);
		...
		void InitProperties() {
			...
			properties[KnownProperties.ButtonBase_CommandParameter] = InitProperty(KnownTypes.ButtonBase,
				"CommandParameter", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.ContentControl_HasContent] = InitProperty(KnownTypes.ContentControl,
				"HasContent", assemblies[3].Find("System.Boolean", true));
			...
			properties[KnownProperties.Control_IsTabStop] =
				InitProperty(KnownTypes.Control, null, assemblies[3].Find("System.Boolean", true));
			...
			properties[KnownProperties.Control_TabIndex] =
				InitProperty(KnownTypes.Control, null, assemblies[3].Find("System.Int32", true));
			...
			properties[KnownProperties.FrameworkElement_MaxHeight] = InitProperty(KnownTypes.FrameworkElement,
				"MaxHeight", assemblies[3].Find("System.Double", true));
			...
			properties[KnownProperties.FrameworkElement_MinHeight] = InitProperty(KnownTypes.FrameworkElement,
				"MinHeight", assemblies[3].Find("System.Double", true));
			...
			properties[KnownProperties.Grid_Column] =
				InitProperty(KnownTypes.Grid, null, assemblies[3].Find("System.Int32", true));
			...
			properties[KnownProperties.HeaderedContentControl_HasHeader] = InitProperty(
				KnownTypes.HeaderedContentControl, "HasHeader", assemblies[3].Find("System.Boolean", true));
			properties[KnownProperties.HeaderedContentControl_Header] = InitProperty(KnownTypes.HeaderedContentControl,
				"Header", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.Page_Content] =
				InitProperty(KnownTypes.Page, "Content", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.Popup_IsOpen] =
				InitProperty(KnownTypes.Popup, "IsOpen", assemblies[3].Find("System.Boolean", true));
			...
			properties[KnownProperties.ScrollViewer_CanContentScroll] = InitProperty(KnownTypes.ScrollViewer,
				"CanContentScroll", assemblies[3].Find("System.Boolean", true));
			...
			properties[KnownProperties.TextBlock_Text] =
				InitProperty(KnownTypes.TextBlock, "Text", assemblies[3].Find("System.Char", true));
			...
			properties[KnownProperties.TextBox_Text] =
				InitProperty(KnownTypes.TextBox, "Text", assemblies[3].Find("System.Char", true));
			...
			properties[KnownProperties.Track_IsDirectionReversed] = InitProperty(KnownTypes.Track,
				"IsDirectionReversed", assemblies[3].Find("System.Boolean", true));
			properties[KnownProperties.Track_Maximum] =
				InitProperty(KnownTypes.Track, "Maximum", assemblies[3].Find("System.Double", true));
			properties[KnownProperties.Track_Minimum] =
				InitProperty(KnownTypes.Track, "Minimum", assemblies[3].Find("System.Double", true));
			...
			properties[KnownProperties.Track_Value] =
				InitProperty(KnownTypes.Track, "Value", assemblies[3].Find("System.Double", true));
			...
			properties[KnownProperties.HeaderedItemsControl_Items] = InitProperty(KnownTypes.HeaderedItemsControl,
				"Items", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.Label_Content] =
				InitProperty(KnownTypes.Label, "Content", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.ListBox_Items] =
				InitProperty(KnownTypes.ListBox, "Items", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.Menu_Items] =
				InitProperty(KnownTypes.Menu, "Items", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.Run_Text] =
				InitProperty(KnownTypes.Run, "Text", assemblies[3].Find("System.Char", true));
			...
			properties[KnownProperties.ToolBar_Items] =
				InitProperty(KnownTypes.ToolBar, "Items", assemblies[3].Find("System.Object", true));
			...
			properties[KnownProperties.XmlDataProvider_XmlSerializer] = InitProperty(KnownTypes.XmlDataProvider,
				"XmlSerializer", assemblies[6].Find("System.Xml.Serialization.IXmlSerializable", true));
		}
	}
}
