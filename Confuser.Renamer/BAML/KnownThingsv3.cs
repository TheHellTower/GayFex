...
namespace Confuser.Renamer.BAML {
	internal class KnownThingsv3 : IKnownThings {
		...
		public KnownThingsv3(IConfuserContext context, ModuleDefMD initMod) {
		...
		Tuple<KnownTypes, PropertyDef, TypeDef> InitProperty(KnownTypes parent, string propertyName,
		...
		void InitAssemblies(ModuleDefMD initMod) {
			assemblies[0] = context.Resolver.ResolveThrow(
				"PresentationFramework, Version=3.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35", initMod);
			assemblies[1] = context.Resolver.ResolveThrow(
				"PresentationCore, Version=3.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35", initMod);
			assemblies[2] =
				context.Resolver.ResolveThrow(
					"mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", initMod);
			assemblies[3] =
				context.Resolver.ResolveThrow(
					"System, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", initMod);
			assemblies[4] =
				context.Resolver.ResolveThrow(
					"WindowsBase, Version=3.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35", initMod);
			assemblies[5] =
				context.Resolver.ResolveThrow(
					"System.Xml, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", initMod);
		}

		void InitTypes() {
			types[KnownTypes.AccessText] = assemblies[0].Find("System.Windows.Controls.AccessText", true);
			types[KnownTypes.AdornedElementPlaceholder] =
				assemblies[0].Find("System.Windows.Controls.AdornedElementPlaceholder", true);
			...
			types[KnownTypes.AffineTransform3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.AffineTransform3D", true);
			...
			types[KnownTypes.AnimationClock] =
				assemblies[1].Find("System.Windows.Media.Animation.AnimationClock", true);
			types[KnownTypes.AnimationTimeline] =
				assemblies[1].Find("System.Windows.Media.Animation.AnimationTimeline", true);
			...
			types[KnownTypes.AxisAngleRotation3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.AxisAngleRotation3D", true);
			types[KnownTypes.BaseIListConverter] =
				assemblies[1].Find("System.Windows.Media.Converters.BaseIListConverter", true);
			types[KnownTypes.BeginStoryboard] =
				assemblies[0].Find("System.Windows.Media.Animation.BeginStoryboard", true);
			types[KnownTypes.BevelBitmapEffect] =
				assemblies[1].Find("System.Windows.Media.Effects.BevelBitmapEffect", true);
			...
			types[KnownTypes.BindingExpressionBase] =
				assemblies[0].Find("System.Windows.Data.BindingExpressionBase", true);
			types[KnownTypes.BindingListCollectionView] =
				assemblies[0].Find("System.Windows.Data.BindingListCollectionView", true);
			...
			types[KnownTypes.BitmapEffectCollection] =
				assemblies[1].Find("System.Windows.Media.Effects.BitmapEffectCollection", true);
			types[KnownTypes.BitmapEffectGroup] =
				assemblies[1].Find("System.Windows.Media.Effects.BitmapEffectGroup", true);
			types[KnownTypes.BitmapEffectInput] =
				assemblies[1].Find("System.Windows.Media.Effects.BitmapEffectInput", true);
			...
			types[KnownTypes.BlurBitmapEffect] =
				assemblies[1].Find("System.Windows.Media.Effects.BlurBitmapEffect", true);
			types[KnownTypes.BmpBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.BmpBitmapDecoder", true);
			types[KnownTypes.BmpBitmapEncoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.BmpBitmapEncoder", true);
			types[KnownTypes.Bold] = assemblies[0].Find("System.Windows.Documents.Bold", true);
			types[KnownTypes.BoolIListConverter] =
				assemblies[1].Find("System.Windows.Media.Converters.BoolIListConverter", true);
			types[KnownTypes.Boolean] = assemblies[2].Find("System.Boolean", true);
			types[KnownTypes.BooleanAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.BooleanAnimationBase", true);
			types[KnownTypes.BooleanAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.BooleanAnimationUsingKeyFrames", true);
			types[KnownTypes.BooleanConverter] = assemblies[3].Find("System.ComponentModel.BooleanConverter", true);
			types[KnownTypes.BooleanKeyFrame] =
			...
			types[KnownTypes.BorderGapMaskConverter] =
				assemblies[0].Find("System.Windows.Controls.BorderGapMaskConverter", true);
			...
			types[KnownTypes.BulletDecorator] =
				assemblies[0].Find("System.Windows.Controls.Primitives.BulletDecorator", true);
			...
			types[KnownTypes.ByteAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.ByteAnimationBase", true);
			...
			types[KnownTypes.ByteKeyFrameCollection] =
				assemblies[1].Find("System.Windows.Media.Animation.ByteKeyFrameCollection", true);
			...
			types[KnownTypes.CharAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.CharAnimationBase", true);
			...
			types[KnownTypes.CharIListConverter] =
				assemblies[1].Find("System.Windows.Media.Converters.CharIListConverter", true);
			types[KnownTypes.CharKeyFrame] = assemblies[1].Find("System.Windows.Media.Animation.CharKeyFrame", true);
			types[KnownTypes.CharKeyFrameCollection] =
				assemblies[1].Find("System.Windows.Media.Animation.CharKeyFrameCollection", true);
			...
			types[KnownTypes.ClockController] =
				assemblies[1].Find("System.Windows.Media.Animation.ClockController", true);
			...
			types[KnownTypes.CollectionViewSource] =
				assemblies[0].Find("System.Windows.Data.CollectionViewSource", true);
			types[KnownTypes.Color] = assemblies[1].Find("System.Windows.Media.Color", true);
			types[KnownTypes.ColorAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.ColorAnimation", true);
			types[KnownTypes.ColorAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.ColorAnimationBase", true);
			...
			types[KnownTypes.ColorConvertedBitmap] =
				assemblies[1].Find("System.Windows.Media.Imaging.ColorConvertedBitmap", true);
			types[KnownTypes.ColorConvertedBitmapExtension] =
				assemblies[0].Find("System.Windows.ColorConvertedBitmapExtension", true);
			...
			types[KnownTypes.ContentPropertyAttribute] =
				assemblies[4].Find("System.Windows.Markup.ContentPropertyAttribute", true);
			types[KnownTypes.ContentWrapperAttribute] =
				assemblies[4].Find("System.Windows.Markup.ContentWrapperAttribute", true);
			types[KnownTypes.ContextMenu] = assemblies[0].Find("System.Windows.Controls.ContextMenu", true);
			types[KnownTypes.ContextMenuService] =
				assemblies[0].Find("System.Windows.Controls.ContextMenuService", true);
			...
			types[KnownTypes.CultureInfoConverter] =
				assemblies[3].Find("System.ComponentModel.CultureInfoConverter", true);
			...
			types[KnownTypes.DataChangedEventManager] =
				assemblies[0].Find("System.Windows.Data.DataChangedEventManager", true);
			...
			types[KnownTypes.DecimalAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.DecimalAnimation", true);
			types[KnownTypes.DecimalAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.DecimalAnimationBase", true);
			types[KnownTypes.DecimalAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.DecimalAnimationUsingKeyFrames", true);
			types[KnownTypes.DecimalConverter] = assemblies[3].Find("System.ComponentModel.DecimalConverter", true);
			types[KnownTypes.DecimalKeyFrame] =
			...
			types[KnownTypes.DiffuseMaterial] =
				assemblies[1].Find("System.Windows.Media.Media3D.DiffuseMaterial", true);
			types[KnownTypes.DirectionalLight] =
				assemblies[1].Find("System.Windows.Media.Media3D.DirectionalLight", true);
			types[KnownTypes.DiscreteBooleanKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteBooleanKeyFrame", true);
			types[KnownTypes.DiscreteByteKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteByteKeyFrame", true);
			types[KnownTypes.DiscreteCharKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteCharKeyFrame", true);
			types[KnownTypes.DiscreteColorKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteColorKeyFrame", true);
			types[KnownTypes.DiscreteDecimalKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteDecimalKeyFrame", true);
			types[KnownTypes.DiscreteDoubleKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteDoubleKeyFrame", true);
			types[KnownTypes.DiscreteInt16KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteInt16KeyFrame", true);
			types[KnownTypes.DiscreteInt32KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteInt32KeyFrame", true);
			types[KnownTypes.DiscreteInt64KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteInt64KeyFrame", true);
			types[KnownTypes.DiscreteMatrixKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteMatrixKeyFrame", true);
			types[KnownTypes.DiscreteObjectKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteObjectKeyFrame", true);
			types[KnownTypes.DiscretePoint3DKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscretePoint3DKeyFrame", true);
			types[KnownTypes.DiscretePointKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscretePointKeyFrame", true);
			...
			types[KnownTypes.DiscreteRectKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteRectKeyFrame", true);
			...
			types[KnownTypes.DiscreteSingleKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteSingleKeyFrame", true);
			types[KnownTypes.DiscreteSizeKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteSizeKeyFrame", true);
			types[KnownTypes.DiscreteStringKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteStringKeyFrame", true);
			...
			types[KnownTypes.DiscreteVectorKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.DiscreteVectorKeyFrame", true);
			types[KnownTypes.DockPanel] = assemblies[0].Find("System.Windows.Controls.DockPanel", true);
			types[KnownTypes.DocumentPageView] =
				assemblies[0].Find("System.Windows.Controls.Primitives.DocumentPageView", true);
			types[KnownTypes.DocumentReference] =
				assemblies[0].Find("System.Windows.Documents.DocumentReference", true);
			types[KnownTypes.DocumentViewer] = assemblies[0].Find("System.Windows.Controls.DocumentViewer", true);
			types[KnownTypes.DocumentViewerBase] =
				assemblies[0].Find("System.Windows.Controls.Primitives.DocumentViewerBase", true);
			types[KnownTypes.Double] = assemblies[2].Find("System.Double", true);
			types[KnownTypes.DoubleAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.DoubleAnimation", true);
			types[KnownTypes.DoubleAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.DoubleAnimationBase", true);
			types[KnownTypes.DoubleAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.DoubleAnimationUsingKeyFrames", true);
			...
			types[KnownTypes.DoubleCollectionConverter] =
				assemblies[1].Find("System.Windows.Media.DoubleCollectionConverter", true);
			types[KnownTypes.DoubleConverter] = assemblies[3].Find("System.ComponentModel.DoubleConverter", true);
			types[KnownTypes.DoubleIListConverter] =
				assemblies[1].Find("System.Windows.Media.Converters.DoubleIListConverter", true);
			types[KnownTypes.DoubleKeyFrame] =
			...
			types[KnownTypes.DropShadowBitmapEffect] =
				assemblies[1].Find("System.Windows.Media.Effects.DropShadowBitmapEffect", true);
			...
			types[KnownTypes.DynamicResourceExtension] =
				assemblies[0].Find("System.Windows.DynamicResourceExtension", true);
			...
			types[KnownTypes.EmbossBitmapEffect] =
				assemblies[1].Find("System.Windows.Media.Effects.EmbossBitmapEffect", true);
			types[KnownTypes.EmissiveMaterial] =
				assemblies[1].Find("System.Windows.Media.Media3D.EmissiveMaterial", true);
			...
			types[KnownTypes.FixedDocumentSequence] =
				assemblies[0].Find("System.Windows.Documents.FixedDocumentSequence", true);
			...
			types[KnownTypes.FlowDocumentPageViewer] =
				assemblies[0].Find("System.Windows.Controls.FlowDocumentPageViewer", true);
			types[KnownTypes.FlowDocumentReader] =
				assemblies[0].Find("System.Windows.Controls.FlowDocumentReader", true);
			types[KnownTypes.FlowDocumentScrollViewer] =
				assemblies[0].Find("System.Windows.Controls.FlowDocumentScrollViewer", true);
			...
			types[KnownTypes.FontFamilyConverter] =
				assemblies[1].Find("System.Windows.Media.FontFamilyConverter", true);
			...
			types[KnownTypes.FormatConvertedBitmap] =
				assemblies[1].Find("System.Windows.Media.Imaging.FormatConvertedBitmap", true);
			types[KnownTypes.Frame] = assemblies[0].Find("System.Windows.Controls.Frame", true);
			types[KnownTypes.FrameworkContentElement] =
				assemblies[0].Find("System.Windows.FrameworkContentElement", true);
			types[KnownTypes.FrameworkElement] = assemblies[0].Find("System.Windows.FrameworkElement", true);
			types[KnownTypes.FrameworkElementFactory] =
				assemblies[0].Find("System.Windows.FrameworkElementFactory", true);
			types[KnownTypes.FrameworkPropertyMetadata] =
				assemblies[0].Find("System.Windows.FrameworkPropertyMetadata", true);
			...
			types[KnownTypes.FrameworkTextComposition] =
				assemblies[0].Find("System.Windows.Documents.FrameworkTextComposition", true);
			...
			types[KnownTypes.GeneralTransformCollection] =
				assemblies[1].Find("System.Windows.Media.GeneralTransformCollection", true);
			types[KnownTypes.GeneralTransformGroup] =
				assemblies[1].Find("System.Windows.Media.GeneralTransformGroup", true);
			...
			types[KnownTypes.GeometryModel3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.GeometryModel3D", true);
			types[KnownTypes.GestureRecognizer] = assemblies[1].Find("System.Windows.Ink.GestureRecognizer", true);
			types[KnownTypes.GifBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.GifBitmapDecoder", true);
			types[KnownTypes.GifBitmapEncoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.GifBitmapEncoder", true);
			...
			types[KnownTypes.GradientStopCollection] =
				assemblies[1].Find("System.Windows.Media.GradientStopCollection", true);
			...
			types[KnownTypes.GridViewColumnHeader] =
				assemblies[0].Find("System.Windows.Controls.GridViewColumnHeader", true);
			types[KnownTypes.GridViewHeaderRowPresenter] =
				assemblies[0].Find("System.Windows.Controls.GridViewHeaderRowPresenter", true);
			types[KnownTypes.GridViewRowPresenter] =
				assemblies[0].Find("System.Windows.Controls.GridViewRowPresenter", true);
			...
			types[KnownTypes.HeaderedContentControl] =
				assemblies[0].Find("System.Windows.Controls.HeaderedContentControl", true);
			types[KnownTypes.HeaderedItemsControl] =
				assemblies[0].Find("System.Windows.Controls.HeaderedItemsControl", true);
			types[KnownTypes.HierarchicalDataTemplate] =
				assemblies[0].Find("System.Windows.HierarchicalDataTemplate", true);
			...
			types[KnownTypes.IComponentConnector] =
				assemblies[4].Find("System.Windows.Markup.IComponentConnector", true);
			...
			types[KnownTypes.IconBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.IconBitmapDecoder", true);
			...
			types[KnownTypes.ImageSourceConverter] =
				assemblies[1].Find("System.Windows.Media.ImageSourceConverter", true);
			...
			types[KnownTypes.InlineUIContainer] =
				assemblies[0].Find("System.Windows.Documents.InlineUIContainer", true);
			...
			types[KnownTypes.InputLanguageManager] =
				assemblies[1].Find("System.Windows.Input.InputLanguageManager", true);
			...
			types[KnownTypes.InputScopeConverter] =
				assemblies[1].Find("System.Windows.Input.InputScopeConverter", true);
			types[KnownTypes.InputScopeName] = assemblies[1].Find("System.Windows.Input.InputScopeName", true);
			types[KnownTypes.InputScopeNameConverter] =
				assemblies[1].Find("System.Windows.Input.InputScopeNameConverter", true);
			types[KnownTypes.Int16] = assemblies[2].Find("System.Int16", true);
			types[KnownTypes.Int16Animation] =
				assemblies[1].Find("System.Windows.Media.Animation.Int16Animation", true);
			types[KnownTypes.Int16AnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.Int16AnimationBase", true);
			...
			types[KnownTypes.Int32Animation] =
				assemblies[1].Find("System.Windows.Media.Animation.Int32Animation", true);
			types[KnownTypes.Int32AnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.Int32AnimationBase", true);
			...
			types[KnownTypes.Int32CollectionConverter] =
				assemblies[1].Find("System.Windows.Media.Int32CollectionConverter", true);
			...
			types[KnownTypes.Int64Animation] =
				assemblies[1].Find("System.Windows.Media.Animation.Int64Animation", true);
			types[KnownTypes.Int64AnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.Int64AnimationBase", true);
			...
			types[KnownTypes.ItemsPanelTemplate] =
			...
			types[KnownTypes.JpegBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.JpegBitmapDecoder", true);
			types[KnownTypes.JpegBitmapEncoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.JpegBitmapEncoder", true);
			...
			types[KnownTypes.KeyGestureConverter] =
				assemblies[1].Find("System.Windows.Input.KeyGestureConverter", true);
			...
			types[KnownTypes.LateBoundBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.LateBoundBitmapDecoder", true);
			...
			types[KnownTypes.LinearByteKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearByteKeyFrame", true);
			types[KnownTypes.LinearColorKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearColorKeyFrame", true);
			types[KnownTypes.LinearDecimalKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearDecimalKeyFrame", true);
			types[KnownTypes.LinearDoubleKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearDoubleKeyFrame", true);
			types[KnownTypes.LinearGradientBrush] =
				assemblies[1].Find("System.Windows.Media.LinearGradientBrush", true);
			types[KnownTypes.LinearInt16KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearInt16KeyFrame", true);
			types[KnownTypes.LinearInt32KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearInt32KeyFrame", true);
			types[KnownTypes.LinearInt64KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearInt64KeyFrame", true);
			types[KnownTypes.LinearPoint3DKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearPoint3DKeyFrame", true);
			types[KnownTypes.LinearPointKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearPointKeyFrame", true);
			types[KnownTypes.LinearQuaternionKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearQuaternionKeyFrame", true);
			types[KnownTypes.LinearRectKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearRectKeyFrame", true);
			types[KnownTypes.LinearRotation3DKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearRotation3DKeyFrame", true);
			types[KnownTypes.LinearSingleKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearSingleKeyFrame", true);
			types[KnownTypes.LinearSizeKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearSizeKeyFrame", true);
			types[KnownTypes.LinearThicknessKeyFrame] =
				assemblies[0].Find("System.Windows.Media.Animation.LinearThicknessKeyFrame", true);
			types[KnownTypes.LinearVector3DKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearVector3DKeyFrame", true);
			types[KnownTypes.LinearVectorKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.LinearVectorKeyFrame", true);
			...
			types[KnownTypes.MaterialCollection] =
				assemblies[1].Find("System.Windows.Media.Media3D.MaterialCollection", true);
			...
			types[KnownTypes.Matrix3DConverter] =
				assemblies[1].Find("System.Windows.Media.Media3D.Matrix3DConverter", true);
			types[KnownTypes.MatrixAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.MatrixAnimationBase", true);
			types[KnownTypes.MatrixAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.MatrixAnimationUsingKeyFrames", true);
			...
			types[KnownTypes.MatrixKeyFrame] =
			...
			types[KnownTypes.MatrixTransform3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.MatrixTransform3D", true);
			...
			types[KnownTypes.Model3DCollection] =
				assemblies[1].Find("System.Windows.Media.Media3D.Model3DCollection", true);
			...
			types[KnownTypes.ModifierKeysConverter] =
				assemblies[4].Find("System.Windows.Input.ModifierKeysConverter", true);
			types[KnownTypes.MouseActionConverter] =
				assemblies[1].Find("System.Windows.Input.MouseActionConverter", true);
			...
			types[KnownTypes.MouseGestureConverter] =
				assemblies[1].Find("System.Windows.Input.MouseGestureConverter", true);
			types[KnownTypes.MultiBinding] = assemblies[0].Find("System.Windows.Data.MultiBinding", true);
			types[KnownTypes.MultiBindingExpression] =
				assemblies[0].Find("System.Windows.Data.MultiBindingExpression", true);
			...
			types[KnownTypes.ObjectAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.ObjectAnimationBase", true);
			types[KnownTypes.ObjectAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.ObjectAnimationUsingKeyFrames", true);
			types[KnownTypes.ObjectDataProvider] = assemblies[0].Find("System.Windows.Data.ObjectDataProvider", true);
			types[KnownTypes.ObjectKeyFrame] =
			...
			types[KnownTypes.OrthographicCamera] =
				assemblies[1].Find("System.Windows.Media.Media3D.OrthographicCamera", true);
			types[KnownTypes.OuterGlowBitmapEffect] =
				assemblies[1].Find("System.Windows.Media.Effects.OuterGlowBitmapEffect", true);
			...
			types[KnownTypes.ParallelTimeline] =
				assemblies[1].Find("System.Windows.Media.Animation.ParallelTimeline", true);
			...
			types[KnownTypes.PathFigureCollection] =
				assemblies[1].Find("System.Windows.Media.PathFigureCollection", true);
			...
			types[KnownTypes.PathSegmentCollection] =
				assemblies[1].Find("System.Windows.Media.PathSegmentCollection", true);
			types[KnownTypes.PauseStoryboard] =
				assemblies[0].Find("System.Windows.Media.Animation.PauseStoryboard", true);
			types[KnownTypes.Pen] = assemblies[1].Find("System.Windows.Media.Pen", true);
			types[KnownTypes.PerspectiveCamera] =
				assemblies[1].Find("System.Windows.Media.Media3D.PerspectiveCamera", true);
			types[KnownTypes.PixelFormat] = assemblies[1].Find("System.Windows.Media.PixelFormat", true);
			types[KnownTypes.PixelFormatConverter] =
				assemblies[1].Find("System.Windows.Media.PixelFormatConverter", true);
			types[KnownTypes.PngBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.PngBitmapDecoder", true);
			types[KnownTypes.PngBitmapEncoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.PngBitmapEncoder", true);
			...
			types[KnownTypes.Point3DAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.Point3DAnimation", true);
			types[KnownTypes.Point3DAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.Point3DAnimationBase", true);
			types[KnownTypes.Point3DAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.Point3DAnimationUsingKeyFrames", true);
			types[KnownTypes.Point3DCollection] =
				assemblies[1].Find("System.Windows.Media.Media3D.Point3DCollection", true);
			...
			types[KnownTypes.Point3DConverter] =
				assemblies[1].Find("System.Windows.Media.Media3D.Point3DConverter", true);
			types[KnownTypes.Point3DKeyFrame] =
			...
			types[KnownTypes.Point4DConverter] =
				assemblies[1].Find("System.Windows.Media.Media3D.Point4DConverter", true);
			types[KnownTypes.PointAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.PointAnimation", true);
			types[KnownTypes.PointAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.PointAnimationBase", true);
			...
			types[KnownTypes.PointCollectionConverter] =
				assemblies[1].Find("System.Windows.Media.PointCollectionConverter", true);
			types[KnownTypes.PointConverter] = assemblies[4].Find("System.Windows.PointConverter", true);
			types[KnownTypes.PointIListConverter] =
				assemblies[1].Find("System.Windows.Media.Converters.PointIListConverter", true);
			...
			types[KnownTypes.PolyQuadraticBezierSegment] =
				assemblies[1].Find("System.Windows.Media.PolyQuadraticBezierSegment", true);
			...
			types[KnownTypes.PriorityBindingExpression] =
				assemblies[0].Find("System.Windows.Data.PriorityBindingExpression", true);
			types[KnownTypes.ProgressBar] = assemblies[0].Find("System.Windows.Controls.ProgressBar", true);
			types[KnownTypes.ProjectionCamera] =
				assemblies[1].Find("System.Windows.Media.Media3D.ProjectionCamera", true);
			...
			types[KnownTypes.QuadraticBezierSegment] =
				assemblies[1].Find("System.Windows.Media.QuadraticBezierSegment", true);
			types[KnownTypes.Quaternion] = assemblies[1].Find("System.Windows.Media.Media3D.Quaternion", true);
			types[KnownTypes.QuaternionAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.QuaternionAnimation", true);
			types[KnownTypes.QuaternionAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.QuaternionAnimationBase", true);
			types[KnownTypes.QuaternionAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.QuaternionAnimationUsingKeyFrames", true);
			types[KnownTypes.QuaternionConverter] =
				assemblies[1].Find("System.Windows.Media.Media3D.QuaternionConverter", true);
			types[KnownTypes.QuaternionKeyFrame] =
			...
			types[KnownTypes.QuaternionRotation3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.QuaternionRotation3D", true);
			types[KnownTypes.RadialGradientBrush] =
				assemblies[1].Find("System.Windows.Media.RadialGradientBrush", true);
			...
			types[KnownTypes.Rect3DConverter] =
				assemblies[1].Find("System.Windows.Media.Media3D.Rect3DConverter", true);
			types[KnownTypes.RectAnimation] = assemblies[1].Find("System.Windows.Media.Animation.RectAnimation", true);
			types[KnownTypes.RectAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.RectAnimationBase", true);
			...
			types[KnownTypes.RectKeyFrameCollection] =
				assemblies[1].Find("System.Windows.Media.Animation.RectKeyFrameCollection", true);
			...
			types[KnownTypes.RemoveStoryboard] =
				assemblies[0].Find("System.Windows.Media.Animation.RemoveStoryboard", true);
			types[KnownTypes.RenderOptions] = assemblies[1].Find("System.Windows.Media.RenderOptions", true);
			types[KnownTypes.RenderTargetBitmap] =
				assemblies[1].Find("System.Windows.Media.Imaging.RenderTargetBitmap", true);
			types[KnownTypes.RepeatBehavior] =
				assemblies[1].Find("System.Windows.Media.Animation.RepeatBehavior", true);
			types[KnownTypes.RepeatBehaviorConverter] =
				assemblies[1].Find("System.Windows.Media.Animation.RepeatBehaviorConverter", true);
			types[KnownTypes.RepeatButton] =
				assemblies[0].Find("System.Windows.Controls.Primitives.RepeatButton", true);
			...
			types[KnownTypes.ResumeStoryboard] =
				assemblies[0].Find("System.Windows.Media.Animation.ResumeStoryboard", true);
			...
			types[KnownTypes.RotateTransform3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.RotateTransform3D", true);
			types[KnownTypes.Rotation3D] = assemblies[1].Find("System.Windows.Media.Media3D.Rotation3D", true);
			types[KnownTypes.Rotation3DAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.Rotation3DAnimation", true);
			types[KnownTypes.Rotation3DAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.Rotation3DAnimationBase", true);
			types[KnownTypes.Rotation3DAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.Rotation3DAnimationUsingKeyFrames", true);
			types[KnownTypes.Rotation3DKeyFrame] =
			...
			types[KnownTypes.RoutedEventConverter] =
				assemblies[0].Find("System.Windows.Markup.RoutedEventConverter", true);
			...
			types[KnownTypes.ScaleTransform3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.ScaleTransform3D", true);
			types[KnownTypes.ScrollBar] = assemblies[0].Find("System.Windows.Controls.Primitives.ScrollBar", true);
			types[KnownTypes.ScrollContentPresenter] =
				assemblies[0].Find("System.Windows.Controls.ScrollContentPresenter", true);
			...
			types[KnownTypes.SeekStoryboard] =
				assemblies[0].Find("System.Windows.Media.Animation.SeekStoryboard", true);
			...
			types[KnownTypes.SingleAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.SingleAnimation", true);
			types[KnownTypes.SingleAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.SingleAnimationBase", true);
			types[KnownTypes.SingleAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.SingleAnimationUsingKeyFrames", true);
			types[KnownTypes.SingleConverter] = assemblies[3].Find("System.ComponentModel.SingleConverter", true);
			types[KnownTypes.SingleKeyFrame] =
			...
			types[KnownTypes.Size3DConverter] =
				assemblies[1].Find("System.Windows.Media.Media3D.Size3DConverter", true);
			types[KnownTypes.SizeAnimation] = assemblies[1].Find("System.Windows.Media.Animation.SizeAnimation", true);
			types[KnownTypes.SizeAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.SizeAnimationBase", true);
			...
			types[KnownTypes.SizeKeyFrameCollection] =
				assemblies[1].Find("System.Windows.Media.Animation.SizeKeyFrameCollection", true);
			types[KnownTypes.SkewTransform] = assemblies[1].Find("System.Windows.Media.SkewTransform", true);
			types[KnownTypes.SkipStoryboardToFill] =
				assemblies[0].Find("System.Windows.Media.Animation.SkipStoryboardToFill", true);
			...
			types[KnownTypes.SpecularMaterial] =
				assemblies[1].Find("System.Windows.Media.Media3D.SpecularMaterial", true);
			types[KnownTypes.SpellCheck] = assemblies[0].Find("System.Windows.Controls.SpellCheck", true);
			types[KnownTypes.SplineByteKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineByteKeyFrame", true);
			types[KnownTypes.SplineColorKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineColorKeyFrame", true);
			types[KnownTypes.SplineDecimalKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineDecimalKeyFrame", true);
			types[KnownTypes.SplineDoubleKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineDoubleKeyFrame", true);
			types[KnownTypes.SplineInt16KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineInt16KeyFrame", true);
			types[KnownTypes.SplineInt32KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineInt32KeyFrame", true);
			types[KnownTypes.SplineInt64KeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineInt64KeyFrame", true);
			types[KnownTypes.SplinePoint3DKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplinePoint3DKeyFrame", true);
			types[KnownTypes.SplinePointKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplinePointKeyFrame", true);
			types[KnownTypes.SplineQuaternionKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineQuaternionKeyFrame", true);
			types[KnownTypes.SplineRectKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineRectKeyFrame", true);
			types[KnownTypes.SplineRotation3DKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineRotation3DKeyFrame", true);
			types[KnownTypes.SplineSingleKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineSingleKeyFrame", true);
			types[KnownTypes.SplineSizeKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineSizeKeyFrame", true);
			types[KnownTypes.SplineThicknessKeyFrame] =
				assemblies[0].Find("System.Windows.Media.Animation.SplineThicknessKeyFrame", true);
			types[KnownTypes.SplineVector3DKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineVector3DKeyFrame", true);
			types[KnownTypes.SplineVectorKeyFrame] =
				assemblies[1].Find("System.Windows.Media.Animation.SplineVectorKeyFrame", true);
			...
			types[KnownTypes.StaticResourceExtension] =
				assemblies[0].Find("System.Windows.StaticResourceExtension", true);
			types[KnownTypes.StatusBar] = assemblies[0].Find("System.Windows.Controls.Primitives.StatusBar", true);
			types[KnownTypes.StatusBarItem] =
				assemblies[0].Find("System.Windows.Controls.Primitives.StatusBarItem", true);
			types[KnownTypes.StickyNoteControl] = assemblies[0].Find("System.Windows.Controls.StickyNoteControl", true);
			types[KnownTypes.StopStoryboard] =
				assemblies[0].Find("System.Windows.Media.Animation.StopStoryboard", true);
			...
			types[KnownTypes.StreamGeometryContext] =
				assemblies[1].Find("System.Windows.Media.StreamGeometryContext", true);
			types[KnownTypes.StreamResourceInfo] =
				assemblies[0].Find("System.Windows.Resources.StreamResourceInfo", true);
			types[KnownTypes.String] = assemblies[2].Find("System.String", true);
			types[KnownTypes.StringAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.StringAnimationBase", true);
			types[KnownTypes.StringAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.StringAnimationUsingKeyFrames", true);
			types[KnownTypes.StringConverter] = assemblies[3].Find("System.ComponentModel.StringConverter", true);
			types[KnownTypes.StringKeyFrame] =
			...
			types[KnownTypes.StrokeCollectionConverter] =
				assemblies[1].Find("System.Windows.StrokeCollectionConverter", true);
			...
			types[KnownTypes.TemplateBindingExpression] =
				assemblies[0].Find("System.Windows.TemplateBindingExpression", true);
			...
			types[KnownTypes.TemplateBindingExtension] =
				assemblies[0].Find("System.Windows.TemplateBindingExtension", true);
			...
			types[KnownTypes.TemplateKeyConverter] =
				assemblies[0].Find("System.Windows.Markup.TemplateKeyConverter", true);
			...
			types[KnownTypes.TextCompositionManager] =
				assemblies[1].Find("System.Windows.Input.TextCompositionManager", true);
			types[KnownTypes.TextDecoration] = assemblies[1].Find("System.Windows.TextDecoration", true);
			types[KnownTypes.TextDecorationCollection] =
				assemblies[1].Find("System.Windows.TextDecorationCollection", true);
			...
			types[KnownTypes.TextEffectCollection] =
				assemblies[1].Find("System.Windows.Media.TextEffectCollection", true);
			...
			types[KnownTypes.ThemeDictionaryExtension] =
				assemblies[0].Find("System.Windows.ThemeDictionaryExtension", true);
			types[KnownTypes.Thickness] = assemblies[0].Find("System.Windows.Thickness", true);
			types[KnownTypes.ThicknessAnimation] =
				assemblies[0].Find("System.Windows.Media.Animation.ThicknessAnimation", true);
			types[KnownTypes.ThicknessAnimationBase] =
				assemblies[0].Find("System.Windows.Media.Animation.ThicknessAnimationBase", true);
			types[KnownTypes.ThicknessAnimationUsingKeyFrames] = assemblies[0]
				.Find("System.Windows.Media.Animation.ThicknessAnimationUsingKeyFrames", true);
			types[KnownTypes.ThicknessConverter] = assemblies[0].Find("System.Windows.ThicknessConverter", true);
			types[KnownTypes.ThicknessKeyFrame] =
			...
			types[KnownTypes.TiffBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.TiffBitmapDecoder", true);
			types[KnownTypes.TiffBitmapEncoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.TiffBitmapEncoder", true);
			...
			types[KnownTypes.TimelineCollection] =
				assemblies[1].Find("System.Windows.Media.Animation.TimelineCollection", true);
			types[KnownTypes.TimelineGroup] = assemblies[1].Find("System.Windows.Media.Animation.TimelineGroup", true);
			types[KnownTypes.ToggleButton] =
				assemblies[0].Find("System.Windows.Controls.Primitives.ToggleButton", true);
			types[KnownTypes.ToolBar] = assemblies[0].Find("System.Windows.Controls.ToolBar", true);
			types[KnownTypes.ToolBarOverflowPanel] =
				assemblies[0].Find("System.Windows.Controls.Primitives.ToolBarOverflowPanel", true);
			types[KnownTypes.ToolBarPanel] =
				assemblies[0].Find("System.Windows.Controls.Primitives.ToolBarPanel", true);
			...
			types[KnownTypes.Transform3DCollection] =
				assemblies[1].Find("System.Windows.Media.Media3D.Transform3DCollection", true);
			types[KnownTypes.Transform3DGroup] =
				assemblies[1].Find("System.Windows.Media.Media3D.Transform3DGroup", true);
			types[KnownTypes.TransformCollection] =
				assemblies[1].Find("System.Windows.Media.TransformCollection", true);
			...
			types[KnownTypes.TransformedBitmap] =
				assemblies[1].Find("System.Windows.Media.Imaging.TransformedBitmap", true);
			types[KnownTypes.TranslateTransform] = assemblies[1].Find("System.Windows.Media.TranslateTransform", true);
			types[KnownTypes.TranslateTransform3D] =
				assemblies[1].Find("System.Windows.Media.Media3D.TranslateTransform3D", true);
			...
			types[KnownTypes.UShortIListConverter] =
				assemblies[1].Find("System.Windows.Media.Converters.UShortIListConverter", true);
			...
			types[KnownTypes.Vector3DAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.Vector3DAnimation", true);
			types[KnownTypes.Vector3DAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.Vector3DAnimationBase", true);
			types[KnownTypes.Vector3DAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.Vector3DAnimationUsingKeyFrames", true);
			types[KnownTypes.Vector3DCollection] =
				assemblies[1].Find("System.Windows.Media.Media3D.Vector3DCollection", true);
			...
			types[KnownTypes.Vector3DConverter] =
				assemblies[1].Find("System.Windows.Media.Media3D.Vector3DConverter", true);
			types[KnownTypes.Vector3DKeyFrame] =
			...
			types[KnownTypes.VectorAnimation] =
				assemblies[1].Find("System.Windows.Media.Animation.VectorAnimation", true);
			types[KnownTypes.VectorAnimationBase] =
				assemblies[1].Find("System.Windows.Media.Animation.VectorAnimationBase", true);
			types[KnownTypes.VectorAnimationUsingKeyFrames] = assemblies[1]
				.Find("System.Windows.Media.Animation.VectorAnimationUsingKeyFrames", true);
			types[KnownTypes.VectorCollection] = assemblies[1].Find("System.Windows.Media.VectorCollection", true);
			types[KnownTypes.VectorCollectionConverter] =
				assemblies[1].Find("System.Windows.Media.VectorCollectionConverter", true);
			types[KnownTypes.VectorConverter] = assemblies[4].Find("System.Windows.VectorConverter", true);
			types[KnownTypes.VectorKeyFrame] =
			...
			types[KnownTypes.Viewport3DVisual] =
				assemblies[1].Find("System.Windows.Media.Media3D.Viewport3DVisual", true);
			types[KnownTypes.VirtualizingPanel] = assemblies[0].Find("System.Windows.Controls.VirtualizingPanel", true);
			types[KnownTypes.VirtualizingStackPanel] =
				assemblies[0].Find("System.Windows.Controls.VirtualizingStackPanel", true);
			...
			types[KnownTypes.WhitespaceSignificantCollectionAttribute] = assemblies[4]
				.Find("System.Windows.Markup.WhitespaceSignificantCollectionAttribute", true);
			types[KnownTypes.Window] = assemblies[0].Find("System.Windows.Window", true);
			types[KnownTypes.WmpBitmapDecoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.WmpBitmapDecoder", true);
			types[KnownTypes.WmpBitmapEncoder] =
				assemblies[1].Find("System.Windows.Media.Imaging.WmpBitmapEncoder", true);
			types[KnownTypes.WrapPanel] = assemblies[0].Find("System.Windows.Controls.WrapPanel", true);
			types[KnownTypes.WriteableBitmap] =
				assemblies[1].Find("System.Windows.Media.Imaging.WriteableBitmap", true);
			types[KnownTypes.XamlBrushSerializer] =
				assemblies[0].Find("System.Windows.Markup.XamlBrushSerializer", true);
			types[KnownTypes.XamlInt32CollectionSerializer] =
				assemblies[0].Find("System.Windows.Markup.XamlInt32CollectionSerializer", true);
			types[KnownTypes.XamlPathDataSerializer] =
				assemblies[0].Find("System.Windows.Markup.XamlPathDataSerializer", true);
			...
			types[KnownTypes.XamlStyleSerializer] =
				assemblies[0].Find("System.Windows.Markup.XamlStyleSerializer", true);
			types[KnownTypes.XamlTemplateSerializer] =
				assemblies[0].Find("System.Windows.Markup.XamlTemplateSerializer", true);
			...
			types[KnownTypes.XmlLangPropertyAttribute] =
				assemblies[4].Find("System.Windows.Markup.XmlLangPropertyAttribute", true);
			types[KnownTypes.XmlLanguage] = assemblies[1].Find("System.Windows.Markup.XmlLanguage", true);
			types[KnownTypes.XmlLanguageConverter] =
				assemblies[1].Find("System.Windows.Markup.XmlLanguageConverter", true);
			types[KnownTypes.XmlNamespaceMapping] = assemblies[0].Find("System.Windows.Data.XmlNamespaceMapping", true);
			types[KnownTypes.ZoomPercentageConverter] =
				assemblies[0].Find("System.Windows.Documents.ZoomPercentageConverter", true);
		}

		void InitProperties() {
			properties[KnownProperties.AccessText_Text] = InitProperty(KnownTypes.AccessText, "Text",
				assemblies[2].Find("System.Char", true));
			properties[KnownProperties.BeginStoryboard_Storyboard] = InitProperty(KnownTypes.BeginStoryboard,
				"Storyboard", assemblies[0].Find("System.Windows.Media.Animation.Storyboard", true));
			properties[KnownProperties.BitmapEffectGroup_Children] = InitProperty(KnownTypes.BitmapEffectGroup,
				"Children", assemblies[1].Find("System.Windows.Media.Effects.BitmapEffect", true));
			...
			properties[KnownProperties.ButtonBase_CommandParameter] = InitProperty(KnownTypes.ButtonBase,
				"CommandParameter", assemblies[2].Find("System.Object", true));
			...
			properties[KnownProperties.ColumnDefinition_MaxWidth] = InitProperty(KnownTypes.ColumnDefinition,
				"MaxWidth", assemblies[2].Find("System.Double", true));
			properties[KnownProperties.ColumnDefinition_MinWidth] = InitProperty(KnownTypes.ColumnDefinition,
				"MinWidth", assemblies[2].Find("System.Double", true));
			...
			properties[KnownProperties.ContentControl_HasContent] = InitProperty(KnownTypes.ContentControl,
				"HasContent", assemblies[2].Find("System.Boolean", true));
			...
			properties[KnownProperties.ContentPresenter_ContentTemplate] = InitProperty(KnownTypes.ContentPresenter,
				"ContentTemplate", assemblies[0].Find("System.Windows.DataTemplate", true));
			properties[KnownProperties.ContentPresenter_ContentTemplateSelector] = InitProperty(
				KnownTypes.ContentPresenter, "ContentTemplateSelector",
			...
			properties[KnownProperties.Control_IsTabStop] =
				InitProperty(KnownTypes.Control, null, assemblies[2].Find("System.Boolean", true));
			properties[KnownProperties.Control_Padding] = InitProperty(KnownTypes.Control, "Padding",
				assemblies[0].Find("System.Windows.Thickness", true));
			properties[KnownProperties.Control_TabIndex] =
				InitProperty(KnownTypes.Control, null, assemblies[2].Find("System.Int32", true));
			...
			properties[KnownProperties.DockPanel_LastChildFill] = InitProperty(KnownTypes.DockPanel, "LastChildFill",
				assemblies[2].Find("System.Boolean", true));
			properties[KnownProperties.DocumentViewerBase_Document] = InitProperty(KnownTypes.DocumentViewerBase,
			...
			properties[KnownProperties.FlowDocumentReader_Document] = InitProperty(KnownTypes.FlowDocumentReader,
				"Document", assemblies[0].Find("System.Windows.Documents.FlowDocument", true));
			properties[KnownProperties.FlowDocumentScrollViewer_Document] = InitProperty(
				KnownTypes.FlowDocumentScrollViewer, "Document",
				assemblies[0].Find("System.Windows.Documents.FlowDocument", true));
			properties[KnownProperties.FrameworkContentElement_Style] = InitProperty(KnownTypes.FrameworkContentElement,
				"Style", assemblies[0].Find("System.Windows.Style", true));
			...
			properties[KnownProperties.FrameworkElement_Margin] = InitProperty(KnownTypes.FrameworkElement, "Margin",
				assemblies[0].Find("System.Windows.Thickness", true));
			properties[KnownProperties.FrameworkElement_MaxHeight] = InitProperty(KnownTypes.FrameworkElement,
				"MaxHeight", assemblies[2].Find("System.Double", true));
			properties[KnownProperties.FrameworkElement_MaxWidth] = InitProperty(KnownTypes.FrameworkElement,
				"MaxWidth", assemblies[2].Find("System.Double", true));
			properties[KnownProperties.FrameworkElement_MinHeight] = InitProperty(KnownTypes.FrameworkElement,
				"MinHeight", assemblies[2].Find("System.Double", true));
			properties[KnownProperties.FrameworkElement_MinWidth] = InitProperty(KnownTypes.FrameworkElement,
				"MinWidth", assemblies[2].Find("System.Double", true));
			...
			properties[KnownProperties.GradientBrush_GradientStops] = InitProperty(KnownTypes.GradientBrush,
				"GradientStops", assemblies[1].Find("System.Windows.Media.GradientStop", true));
			properties[KnownProperties.Grid_Column] =
				InitProperty(KnownTypes.Grid, null, assemblies[2].Find("System.Int32", true));
			properties[KnownProperties.Grid_ColumnSpan] =
				InitProperty(KnownTypes.Grid, null, assemblies[2].Find("System.Int32", true));
			properties[KnownProperties.Grid_Row] =
				InitProperty(KnownTypes.Grid, null, assemblies[2].Find("System.Int32", true));
			properties[KnownProperties.Grid_RowSpan] =
				InitProperty(KnownTypes.Grid, null, assemblies[2].Find("System.Int32", true));
			properties[KnownProperties.GridViewColumn_Header] = InitProperty(KnownTypes.GridViewColumn, "Header",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.HeaderedContentControl_HasHeader] = InitProperty(
				KnownTypes.HeaderedContentControl, "HasHeader", assemblies[2].Find("System.Boolean", true));
			properties[KnownProperties.HeaderedContentControl_Header] = InitProperty(KnownTypes.HeaderedContentControl,
				"Header", assemblies[2].Find("System.Object", true));
			properties[KnownProperties.HeaderedContentControl_HeaderTemplate] = InitProperty(
				KnownTypes.HeaderedContentControl, "HeaderTemplate",
				assemblies[0].Find("System.Windows.DataTemplate", true));
			properties[KnownProperties.HeaderedContentControl_HeaderTemplateSelector] = InitProperty(
				KnownTypes.HeaderedContentControl, "HeaderTemplateSelector",
				assemblies[0].Find("System.Windows.Controls.DataTemplateSelector", true));
			...
			properties[KnownProperties.HeaderedItemsControl_Header] = InitProperty(KnownTypes.HeaderedItemsControl,
				"Header", assemblies[2].Find("System.Object", true));
			properties[KnownProperties.HeaderedItemsControl_HeaderTemplate] = InitProperty(
				KnownTypes.HeaderedItemsControl, "HeaderTemplate",
				assemblies[0].Find("System.Windows.DataTemplate", true));
			properties[KnownProperties.HeaderedItemsControl_HeaderTemplateSelector] = InitProperty(
				KnownTypes.HeaderedItemsControl, "HeaderTemplateSelector",
				assemblies[0].Find("System.Windows.Controls.DataTemplateSelector", true));
			...
			properties[KnownProperties.ItemsControl_ItemTemplate] = InitProperty(KnownTypes.ItemsControl,
				"ItemTemplate", assemblies[0].Find("System.Windows.DataTemplate", true));
			...
			properties[KnownProperties.Page_Content] =
				InitProperty(KnownTypes.Page, "Content", assemblies[2].Find("System.Object", true));
			...
			properties[KnownProperties.Popup_IsOpen] =
				InitProperty(KnownTypes.Popup, "IsOpen", assemblies[2].Find("System.Boolean", true));
			...
			properties[KnownProperties.RowDefinition_MinHeight] = InitProperty(KnownTypes.RowDefinition, "MinHeight",
				assemblies[2].Find("System.Double", true));
			properties[KnownProperties.ScrollViewer_CanContentScroll] = InitProperty(KnownTypes.ScrollViewer,
				"CanContentScroll", assemblies[2].Find("System.Boolean", true));
			properties[KnownProperties.ScrollViewer_HorizontalScrollBarVisibility] = InitProperty(
				KnownTypes.ScrollViewer, "HorizontalScrollBarVisibility",
				assemblies[0].Find("System.Windows.Controls.ScrollBarVisibility", true));
			...
			properties[KnownProperties.TextBlock_Foreground] = InitProperty(KnownTypes.TextBlock, "Foreground",
				assemblies[1].Find("System.Windows.Media.Brush", true));
			properties[KnownProperties.TextBlock_Text] =
				InitProperty(KnownTypes.TextBlock, "Text", assemblies[2].Find("System.Char", true));
			properties[KnownProperties.TextBlock_TextDecorations] = InitProperty(KnownTypes.TextBlock,
				"TextDecorations", assemblies[1].Find("System.Windows.TextDecoration", true));
			...
			properties[KnownProperties.TextBox_Text] =
				InitProperty(KnownTypes.TextBox, "Text", assemblies[2].Find("System.Char", true));
			...
			properties[KnownProperties.Track_IsDirectionReversed] = InitProperty(KnownTypes.Track,
				"IsDirectionReversed", assemblies[2].Find("System.Boolean", true));
			properties[KnownProperties.Track_Maximum] =
				InitProperty(KnownTypes.Track, "Maximum", assemblies[2].Find("System.Double", true));
			properties[KnownProperties.Track_Minimum] =
				InitProperty(KnownTypes.Track, "Minimum", assemblies[2].Find("System.Double", true));
			...
			properties[KnownProperties.Track_Value] =
				InitProperty(KnownTypes.Track, "Value", assemblies[2].Find("System.Double", true));
			properties[KnownProperties.Track_ViewportSize] = InitProperty(KnownTypes.Track, "ViewportSize",
				assemblies[2].Find("System.Double", true));
			properties[KnownProperties.Transform3DGroup_Children] = InitProperty(KnownTypes.Transform3DGroup,
				"Children", assemblies[1].Find("System.Windows.Media.Media3D.Transform3D", true));
			...
			properties[KnownProperties.UIElement_IsEnabled] = InitProperty(KnownTypes.UIElement, "IsEnabled",
				assemblies[2].Find("System.Boolean", true));
			properties[KnownProperties.UIElement_RenderTransform] = InitProperty(KnownTypes.UIElement,
				"RenderTransform", assemblies[1].Find("System.Windows.Media.Transform", true));
			...
			properties[KnownProperties.AdornedElementPlaceholder_Child] = InitProperty(
				KnownTypes.AdornedElementPlaceholder, "Child", assemblies[1].Find("System.Windows.UIElement", true));
			...
			properties[KnownProperties.BooleanAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.BooleanAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.BooleanKeyFrame", true));
			...
			properties[KnownProperties.ButtonBase_Content] = InitProperty(KnownTypes.ButtonBase, "Content",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.ByteAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.ByteAnimationUsingKeyFrames, "KeyFrames",
			...
			properties[KnownProperties.Canvas_Children] = InitProperty(KnownTypes.Canvas, "Children",
				assemblies[1].Find("System.Windows.UIElement", true));
			properties[KnownProperties.CharAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.CharAnimationUsingKeyFrames, "KeyFrames",
			...
			properties[KnownProperties.CheckBox_Content] = InitProperty(KnownTypes.CheckBox, "Content",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.ColorAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.ColorAnimationUsingKeyFrames, "KeyFrames",
			...
			properties[KnownProperties.ContextMenu_Items] = InitProperty(KnownTypes.ContextMenu, "Items",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.ControlTemplate_VisualTree] = InitProperty(KnownTypes.ControlTemplate,
			...
			properties[KnownProperties.DecimalAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.DecimalAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.DecimalKeyFrame", true));
			...
			properties[KnownProperties.DoubleAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.DoubleAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.DoubleKeyFrame", true));
			...
			properties[KnownProperties.FixedDocumentSequence_References] = InitProperty(
				KnownTypes.FixedDocumentSequence, "References",
				assemblies[0].Find("System.Windows.Documents.DocumentReference", true));
			...
			properties[KnownProperties.FlowDocument_Blocks] = InitProperty(KnownTypes.FlowDocument, "Blocks",
				assemblies[0].Find("System.Windows.Documents.Block", true));
			properties[KnownProperties.FlowDocumentPageViewer_Document] = InitProperty(
				KnownTypes.FlowDocumentPageViewer, "Document",
				assemblies[1].Find("System.Windows.Documents.IDocumentPaginatorSource", true));
			properties[KnownProperties.FrameworkTemplate_VisualTree] = InitProperty(KnownTypes.FrameworkTemplate,
				"VisualTree", assemblies[0].Find("System.Windows.FrameworkElementFactory", true));
			...
			properties[KnownProperties.GridViewColumnHeader_Content] = InitProperty(KnownTypes.GridViewColumnHeader,
			...
			properties[KnownProperties.HeaderedContentControl_Content] = InitProperty(KnownTypes.HeaderedContentControl,
				"Content", assemblies[2].Find("System.Object", true));
			properties[KnownProperties.HeaderedItemsControl_Items] = InitProperty(KnownTypes.HeaderedItemsControl,
				"Items", assemblies[2].Find("System.Object", true));
			properties[KnownProperties.HierarchicalDataTemplate_VisualTree] = InitProperty(
				KnownTypes.HierarchicalDataTemplate, "VisualTree",
				assemblies[0].Find("System.Windows.FrameworkElementFactory", true));
			...
			properties[KnownProperties.Int16AnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.Int16AnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.Int16KeyFrame", true));
			properties[KnownProperties.Int32AnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.Int32AnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.Int32KeyFrame", true));
			properties[KnownProperties.Int64AnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.Int64AnimationUsingKeyFrames, "KeyFrames",
			...
			properties[KnownProperties.ItemsControl_Items] = InitProperty(KnownTypes.ItemsControl, "Items",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.ItemsPanelTemplate_VisualTree] = InitProperty(KnownTypes.ItemsPanelTemplate,
				"VisualTree", assemblies[0].Find("System.Windows.FrameworkElementFactory", true));
			properties[KnownProperties.Label_Content] =
				InitProperty(KnownTypes.Label, "Content", assemblies[2].Find("System.Object", true));
			...
			properties[KnownProperties.ListBox_Items] =
				InitProperty(KnownTypes.ListBox, "Items", assemblies[2].Find("System.Object", true));
			...
			properties[KnownProperties.ListViewItem_Content] = InitProperty(KnownTypes.ListViewItem, "Content",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.MatrixAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.MatrixAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.MatrixKeyFrame", true));
			properties[KnownProperties.Menu_Items] =
				InitProperty(KnownTypes.Menu, "Items", assemblies[2].Find("System.Object", true));
			...
			properties[KnownProperties.MultiTrigger_Setters] = InitProperty(KnownTypes.MultiTrigger, "Setters",
				assemblies[0].Find("System.Windows.SetterBase", true));
			properties[KnownProperties.ObjectAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.ObjectAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.ObjectKeyFrame", true));
			...
			properties[KnownProperties.Paragraph_Inlines] = InitProperty(KnownTypes.Paragraph, "Inlines",
				assemblies[0].Find("System.Windows.Documents.Inline", true));
			properties[KnownProperties.ParallelTimeline_Children] = InitProperty(KnownTypes.ParallelTimeline,
				"Children", assemblies[1].Find("System.Windows.Media.Animation.Timeline", true));
			properties[KnownProperties.Point3DAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.Point3DAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.Point3DKeyFrame", true));
			properties[KnownProperties.PointAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.PointAnimationUsingKeyFrames, "KeyFrames",
			...
			properties[KnownProperties.PriorityBinding_Bindings] = InitProperty(KnownTypes.PriorityBinding, "Bindings",
				assemblies[0].Find("System.Windows.Data.BindingBase", true));
			properties[KnownProperties.QuaternionAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.QuaternionAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.QuaternionKeyFrame", true));
			...
			properties[KnownProperties.RadioButton_Content] = InitProperty(KnownTypes.RadioButton, "Content",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.RectAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.RectAnimationUsingKeyFrames, "KeyFrames",
			...
			properties[KnownProperties.RichTextBox_Document] = InitProperty(KnownTypes.RichTextBox, "Document",
				assemblies[0].Find("System.Windows.Documents.FlowDocument", true));
			properties[KnownProperties.Rotation3DAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.Rotation3DAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.Rotation3DKeyFrame", true));
			properties[KnownProperties.Run_Text] =
				InitProperty(KnownTypes.Run, "Text", assemblies[2].Find("System.Char", true));
			...
			properties[KnownProperties.Selector_Items] = InitProperty(KnownTypes.Selector, "Items",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.SingleAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.SingleAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.SingleKeyFrame", true));
			properties[KnownProperties.SizeAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.SizeAnimationUsingKeyFrames, "KeyFrames",
			...
			properties[KnownProperties.Storyboard_Children] = InitProperty(KnownTypes.Storyboard, "Children",
				assemblies[1].Find("System.Windows.Media.Animation.Timeline", true));
			properties[KnownProperties.StringAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.StringAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.StringKeyFrame", true));
			...
			properties[KnownProperties.TextBlock_Inlines] = InitProperty(KnownTypes.TextBlock, "Inlines",
				assemblies[0].Find("System.Windows.Documents.Inline", true));
			properties[KnownProperties.ThicknessAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.ThicknessAnimationUsingKeyFrames, "KeyFrames",
				assemblies[0].Find("System.Windows.Media.Animation.ThicknessKeyFrame", true));
			properties[KnownProperties.ToggleButton_Content] = InitProperty(KnownTypes.ToggleButton, "Content",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.ToolBar_Items] =
				InitProperty(KnownTypes.ToolBar, "Items", assemblies[2].Find("System.Object", true));
			properties[KnownProperties.ToolBarOverflowPanel_Children] = InitProperty(KnownTypes.ToolBarOverflowPanel,
			...
			properties[KnownProperties.UserControl_Content] = InitProperty(KnownTypes.UserControl, "Content",
				assemblies[2].Find("System.Object", true));
			properties[KnownProperties.Vector3DAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.Vector3DAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.Vector3DKeyFrame", true));
			properties[KnownProperties.VectorAnimationUsingKeyFrames_KeyFrames] = InitProperty(
				KnownTypes.VectorAnimationUsingKeyFrames, "KeyFrames",
				assemblies[1].Find("System.Windows.Media.Animation.VectorKeyFrame", true));
			properties[KnownProperties.Viewbox_Child] = InitProperty(KnownTypes.Viewbox, "Child",
				assemblies[1].Find("System.Windows.UIElement", true));
			properties[KnownProperties.Viewport3DVisual_Children] = InitProperty(KnownTypes.Viewport3DVisual,
				"Children", assemblies[1].Find("System.Windows.Media.Media3D.Visual3D", true));
			properties[KnownProperties.VirtualizingPanel_Children] = InitProperty(KnownTypes.VirtualizingPanel,
				"Children", assemblies[1].Find("System.Windows.UIElement", true));
			properties[KnownProperties.VirtualizingStackPanel_Children] = InitProperty(
				KnownTypes.VirtualizingStackPanel, "Children", assemblies[1].Find("System.Windows.UIElement", true));
			...
			properties[KnownProperties.WrapPanel_Children] = InitProperty(KnownTypes.WrapPanel, "Children",
				assemblies[1].Find("System.Windows.UIElement", true));
			properties[KnownProperties.XmlDataProvider_XmlSerializer] = InitProperty(KnownTypes.XmlDataProvider,
				"XmlSerializer", assemblies[5].Find("System.Xml.Serialization.IXmlSerializable", true));
		}
	}
}
