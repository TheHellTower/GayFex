...
namespace Confuser.Renamer {
	public interface INameReference {
		...
		bool DelayRenaming(IConfuserContext context, INameService service, IDnlibDef currentDef);
		...
		/// </summary>
		/// <param name="context">
		///		The context used to get the original name;
		...
		string ToString(IConfuserContext context, INameService nameService);
	}
